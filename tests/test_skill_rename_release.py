...
version (now 0.13.1) so the file doubles as the live "is the
...
edits (the 0.13.1 cycle didn't touch the skill rename text).
"""
...
def test_package_version_resolves_to_current():
    ...
    import sage_memory
    assert sage_memory.__version__ == "0.13.1"
